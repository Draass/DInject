...
namespace DInject.Internal
{
    public static class Assert
    {
        ...
        public static void Warn(bool condition)
        {
            if (!condition)
            {
                DInject.Internal.Log.Warn("Warning!  See call stack");
            }
        }
        ...
        public static void Warn(bool condition, Func<string> messageGenerator)
        {
            if (!condition)
            {
                DInject.Internal.Log.Warn("Warning Assert hit! " + messageGenerator());
            }
        }
        ...
        public static void Warn(bool condition, string message)
        {
            if (!condition)
            {
                DInject.Internal.Log.Warn("Warning Assert hit! " + message);
            }
        }
