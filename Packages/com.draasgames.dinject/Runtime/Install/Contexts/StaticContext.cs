...
namespace DInject
{
    // For some platforms, it's desirable to be able to add dependencies to DInject before
    // Unity even starts up (eg. WSA as described here https://github.com/svermeulen/DInject/issues/118)
